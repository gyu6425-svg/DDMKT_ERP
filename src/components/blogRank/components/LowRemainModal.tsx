    ...
    return (
        ...
        >
            <div className="flex max-h-[85vh] w-[min(560px,94vw)] flex-col rounded-2xl bg-white p-6">
                <h3 className="m-0 text-lg font-bold text-[#0f172a]">재계약 임박 블로그 · 잔여 3건 이하</h3>
                <p className="mt-1 mb-3 text-sm text-[#64748b]">
                    빨강 = 잔여 1건 이하(매우 임박) · 노랑 = 2~3건. 클릭하면 관리 시트로 이동합니다.
                </p>
                ...
                <div className="grid gap-1 overflow-y-auto">
                    {list.length ? (
                        ...
                        <p className="m-0 py-10 text-center text-sm text-[#94a3b8]">잔여 3건 이하 블로그가 없습니다.</p>
                    )}
                </div>
