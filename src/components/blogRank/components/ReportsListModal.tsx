...
// 기자단 보고 목록 모달(기자단 뷰, 읽기 전용) — status 없으면 전체(보고한 글), 'rejected'면 반려만.
                ...
                {loading ? (
                    ...
                    <div className="grid gap-2">
                        {reports.map((r) => {
                            ...
                            return (
                                <div
                                    className="flex items-start justify-between gap-2 rounded-md border border-[#e2e8f0] p-3"
                                    key={r.id}
                                >
                                    ...
                                    <span
                                        className={`shrink-0 rounded-full px-2 py-0.5 text-[11px] font-bold ${c.c}`}
                                    >
                                        {c.t}
                                    </span>
                                </div>
