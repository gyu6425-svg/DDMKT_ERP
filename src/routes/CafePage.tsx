...
function CafePage() {
    ...
    const [activeTab, setActiveTab] = useState<'draft' | 'test' | 'test2' | 'leak2' | 'leak3' | 'theman' | 'theman2' | 'banner' | 'saved'>('leak2');
    ...
    return (
        <section className="grid gap-5">
            ...
            {activeTab === 'theman' ? <CafeThemanTab /> : activeTab === 'leak2' ? <CafeBannerTab /> : activeTab === 'leak3' ? <CafeBannerTab abModel /> : activeTab === 'theman2' ? <CafeBanner2Tab /> : activeTab === 'banner' ? <CafeBannerTab /> : activeTab === 'saved' ? <CafeSavedTab /> : activeTab === 'test' ? <CafeTestTab /> : activeTab === 'test2' ? <CafeTestTab cardMode="hero" /> : (
            <>
