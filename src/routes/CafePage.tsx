...
function CafePage() {
    ...
    const [activeTab, setActiveTab] = useState<'draft' | 'test' | 'test2' | 'theman' | 'theman2' | 'banner' | 'saved'>('banner');
    ...
    return (
        <section className="grid gap-5">
            ...
            {activeTab === 'theman' ? <CafeThemanTab /> : activeTab === 'theman2' ? <CafeTheman2Tab /> : activeTab === 'banner' ? <CafeBannerTab /> : activeTab === 'saved' ? <CafeSavedTab /> : activeTab === 'test' ? <CafeTestTab /> : activeTab === 'test2' ? <CafeTestTab cardMode="hero" /> : (
            <>
