...
CASES = [
    ...
    # 카드 단위 카운트(당근/사이트 전부): 1블록 2카드(당근 등)도 각각 셈 → 기존 블록단위보다 값↑.
    ("석남동 통합탭", c._rank_in_popular, "통합탭_석남동_누수탐지_2026_06_19.html", OUR, 5, "ok"),
    ("인천석남동 통합탭", c._rank_in_popular, "통합탭_2026_06_19.html", OUR, 5, "ok"),
    ("인천연희동 통합탭(사이트 포함)", c._rank_in_popular, "통합탭_인천_연희동_누수탐지_2026_06_19.html", "rlawhddls125", 7, "ok"),
...
PERPOST2_CASES = [
    # 카드 단위 카운트: 위쪽 사이트(오늘의집/당근 류) 4개를 다 세서 pjyysh=7(기존 블록단위 5).
    ("통합탭 글단위 카드대표글(5/15)", "pjyysh", "224286383537", 7, "ok"),
    ("통합탭 글단위 관련글(6/11,권외)", "pjyysh", "224312956224", c.OUT_OF_RANK, "out"),
    ("통합탭 blogId(칠곡 pjyysh)", "pjyysh", "", 7, "ok"),
]
