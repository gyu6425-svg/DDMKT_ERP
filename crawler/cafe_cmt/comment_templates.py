...
TEMPLATES_SECURITY = [
    ...
    # 질문형(섞어서 자연스럽게)
    '{지역} 보안업체 혹시 견적은 어느정도 잡으면 될까요?',
    '{지역}쪽도 상담 출장 되나요? 사무실 보안 알아보는 중이에요',
    '{지역} 보안 설치하려면 보통 얼마나 걸리나요?',
]
...
TEMPLATES_FIRE = [
    ...
    # 질문형(섞어서 자연스럽게)
    '{지역} 소방점검 비용은 보통 어느정도인가요?',
    '{지역}쪽도 출장 점검 되나요? 소방 알아보고 있어요',
    '{지역} 소방점검 얼마나 자주 받아야 하나요?',
]
...
TEMPLATES_CLEANING = [
    ...
    # 질문형(섞어서 자연스럽게)
    '{지역} 입주청소 혹시 평수당 비용 어느정도 잡으면 될까요?',
    '{지역}쪽도 출장 되나요? 입주청소 알아보는 중이에요',
    '{지역} 입주청소 이사 전에 미리 예약해야 하나요?',
]
...
GENERIC_HEAD = {"회사", "사무실", "빌딩", "건물", "공장", "상가", "매장", "점포",
                ...
                "더티클리닉", "설고점", "설고"}   # 브랜드명이 지역+키워드 사이에 끼면 지역으로 오인 → 걸러냄
