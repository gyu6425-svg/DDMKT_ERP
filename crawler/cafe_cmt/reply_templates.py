...
# --- 입주청소(더티클리닉) 전용 (임시, 확정 문구 받으면 교체) --------------------
PLAIN_CLEANING = [
    '감사합니다~ 도움 되셨다면 다행이네요',
    '읽어주셔서 감사합니다!',
    '도움이 됐다니 다행이에요 :)',
    '네 저도 이사할 때 알아보다가 정리해봤어요',
    '공감해주셔서 감사합니다~',
    '이사철엔 미리 예약해두는 게 낫더라구요',
    '별거 아닌데 봐주셔서 감사해요!',
    '궁금한 거 있으시면 편하게 물어보세요~',
    '도움 되셨다니 저도 뿌듯하네요 :)',
    '입주 전에 청소 한 번 하면 확실히 다르더라구요 참고되셨으면 좋겠어요',
]

WITH_REGION_CLEANING = [
    '{지역}쪽도 출장 되는 걸로 알고 있어요~',
    '{지역} 근처시면 참고하시면 좋을 것 같아요!',
    '{키워드}{은는} 미리 예약해두는 게 낫더라구요. 도움 되셨으면 좋겠어요',
    '{지역}에서도 비슷한 문의 많다고 하시더라구요~',
    '{키워드} 알아보실 때 참고되셨으면 좋겠습니다!',
]
...
POOLS = {
    ...
    '입주청소': (PLAIN_CLEANING, WITH_REGION_CLEANING),
}
