...
#   2026-08-06 데몬 실측(판정 6,204건)으로 재조정:
#     신도시 74.0%(37/50) · 시군구 21.0%(577/2747) · 시도 18.5% · 동 7.7% · 접미형 4.4% · 역세권 0.0%(0/79)
#   ★ 신도시가 시군구의 3.5배다. 업종이 전혀 달라도(입주청소·누수탐지) 잡히는 신도시가 겹친다
#     — 동탄·미사·배곧·삼송·상암. 업종 특성이 아니라 신도시 카페 자체가 활성화된 것으로 보인다.
#   ★ 역세권은 청소·누수에서 0/79. '강남역 입주청소'로는 검색하지 않는다(출장 서비스).
#     다만 네일은 역세권 57%(2026-08-06 이전 실측)라 업종 의존이다 → 지우지 않고 뒤로만 둔다.
PRIO = {"sido": 15, "sigungu": 20, "newtown": 10, "district": 25,
