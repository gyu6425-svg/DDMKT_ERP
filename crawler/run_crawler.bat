...
start "ddmkt-full" /min cmd /c "C:\Users\ddmkt\AppData\Local\Python\pythoncore-3.14-64\python.exe blog_rank_crawler.py --spread --chunk-size 5 --deadline 08:30 >> crawler.log 2>&1 & echo [CAFE-RANK-START] %date% %time% >> crawler.log & C:\Users\ddmkt\AppData\Local\Python\pythoncore-3.14-64\python.exe cafe_rank_crawler.py >> crawler.log 2>&1"
